...
from app.api.v1.endpoints import auth, order, product, inventory, inbound_order, return_order, test
...
api_router.include_router(inbound_order.router, prefix="/inbound_order", tags=["入库单管理"])
api_router.include_router(return_order.router, prefix="/return_order", tags=["退货单管理"])
